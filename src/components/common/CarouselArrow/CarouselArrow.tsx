...
export function CarouselArrow({ variant, onClick }: CarouselArrowProps) {
  ...
  return (
    <div
      className={`absolute h-full w-fit flex items-center toDarkGradient ${positionVariant}`}
    >
      <button
        onClick={onClick}
        className={`relative w-[100px] h-[100px] rounded-full border border-primary-white z-1001 hover:scale-95`}
      >
        <IconRetriever
          style="m-auto"
